    ...
    " alt="">
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="col-12 text-center">
                                <a class="iconRedes" href="">
                                    <i class="fab fa-facebook-square"></i>
                                </a>
                            </div>
                            <div class="col-12 text-justify posDescripcion">
                                <p class="descriptionUser">
                                    Lorem Ipsum Lorem IpsumLorem IpsumLorem IpsumLorem Ipsum Lorem Ipsum v¿Lorem Ipsum Lorem Ipsum Lorem Ipsum Lorem Ipsum Lorem Ipsum
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12 col-md-4 text-left">
                    <div class="col-12 np">
                        <button @click="cambiarContrasena" class="btnModificarPass">
                        ...
                        <form @submit="formDatos" autocomplete="off">
                            ...
                            <div v-if="changeDatos" class="col-12 np">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea @change="getdescripcionProfile" class="inputProfile" rows="5" placeholder="Mi Descripción"></textarea>
                                </div>
                                <div class="col-12 text-center">
...
.btnCancelarDatos:hover,.btnCancelarDatos:focus{
